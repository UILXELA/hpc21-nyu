...
//
{
  ...
  x = ( int * ) malloc ( (n+1) * sizeof ( int ) ); //modifed n to n+1 since the purpose is to get N+1 entries of the series. The first entry 1 is also stored in x. So n+1 slots needed.
