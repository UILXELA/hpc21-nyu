...
int main(int argc, char** argv) {
  ...
  for (long p = PFIRST; p < PLAST; p += PINC) {
    ...
    double bandwidth = (2*m*n*k/BLOCK_SIZE/BLOCK_SIZE/BLOCK_SIZE +2*m*n/BLOCK_SIZE/BLOCK_SIZE) * NREPEATS * sizeof(double) * BLOCK_SIZE * BLOCK_SIZE / 1e9 /time ; // TODO: calculate from m, n, k, NREPEATS, time
    //double bandwidth = (3*m*n+ m*n*k) * NREPEATS * sizeof(double) / 1e9 /time; // TODO: calculate from m, n, k, NREPEATS, time
